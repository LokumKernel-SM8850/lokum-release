...
PROXMOX_RUNNER_DISK_GB="${PROXMOX_RUNNER_DISK_GB:-16}"
PROXMOX_RUNNER_CORES="${PROXMOX_RUNNER_CORES:-1}"
PROXMOX_RUNNER_MEMORY_MB="${PROXMOX_RUNNER_MEMORY_MB:-1024}"
PROXMOX_RUNNER_SWAP_MB="${PROXMOX_RUNNER_SWAP_MB:-512}"
